...
method: 提出一种结合机器学习与集成评分滤波器（EnSF）的混合框架，利用无训练扩散模型实现高效的数据同化。
result: 在Lorenz-96系统和KdV方程的预测实验中，该框架有效减少了预测不确定性并提高了精度。
conclusion: 将生成式AI驱动的数据同化技术集成到机器学习中，能显著增强数据驱动动力系统的长期预测能力。
---
